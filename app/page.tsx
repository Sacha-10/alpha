      ...
      <main className="relative z-[2] pt-28">
        ...
        <RevealSection className="bg-background px-6 py-20 md:py-[120px]">
          <div className="mx-auto max-w-6xl text-center">
            ...
            <h2 className="mx-auto mt-8 max-w-5xl text-3xl font-bold leading-tight text-primary md:text-5xl">
              Propulsé par{" "}
            ...
            <p className="mx-auto mt-6 max-w-4xl text-lg text-secondary">
          ...
          <div className="pointer-events-none absolute left-1/2 top-1/2 h-80 w-80 -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue/10 blur-3xl" />
        </RevealSection>
        ...
        <RevealSection className="bg-card px-6 py-20 md:py-[120px]">
          <div className="mx-auto max-w-6xl">
            ...
            <p className="mx-auto mt-5 max-w-4xl text-center text-lg text-secondary">
