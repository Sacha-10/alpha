...
const plans: Plan[] = [
  {
    ...
    features: [
      ...
      { label: "Journal de vos analyses (1 mois)", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Analyses IA GPT-5.4", included: true },
      { label: "Export PDF", included: true },
      { label: "Journal de vos analyses (1 an)", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Analyses IA GPT-5.4", included: true },
      { label: "Export PDF", included: true },
      { label: "Journal de vos analyses (illimité)", included: true },
