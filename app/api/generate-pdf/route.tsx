...
export async function POST(req: NextRequest) {
  try {
    ...
    // Mobile: subtract 74px (main p-6 both sides = 48px + card border both sides = 2px
    // + accordion content px-3 both sides = 24px) so the PDF content width matches
    // what TradeReport sees inside the accordion card.
    const viewportWidth = screenWidth < 640 ? Math.max(320, screenWidth - 74) : 1200;
