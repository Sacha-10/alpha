        ...
        <div className="flex max-h-[calc(100vh-3.5rem)] shrink-0 flex-col overflow-hidden border-b border-border bg-card md:hidden" style={{ backgroundColor: '#12121A' }}>
          ...
          <div className="shrink-0 px-4 py-3" style={{ backgroundColor: '#12121A' }}>
            ...
            <button
              ...
              className="mt-3 flex w-full cursor-pointer items-center rounded-lg text-xs text-secondary transition-all duration-150 hover:bg-hover hover:text-primary"
            >
              Déconnexion
            </button>
          </div>
